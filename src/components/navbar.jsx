...
export default function Navbar({ pageOn, handlePageChange }) {
    ...
    return (
      <nav
        className='navbar is-dark has-shadow column is-narrow'
        role='navigation'
        ...
        >
          <div className='navbar-end'>
            <a
              ...
              className={
                pageOn === 'About Me' ? 'navbar-item is-active' : 'navbar-item'
              }
            >
              About Me
            </a>
            <a
              ...
              className={
                pageOn === 'Portfolio' ? 'navbar-item is-active' : 'navbar-item'
              }
            >
              Portfolio
            </a>
